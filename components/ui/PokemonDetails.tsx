    ...
    <div className="rounded-lg shadow-lg overflow-hidden" style={{ 'backgroundColor': backgroundColor }}>
      <div className="p-3 sm:p-6">
        ...
        <div className="flex flex-col md:flex-row gap-4 rounded-lg">
          ...
          <div className="w-full md:w-1/2 bg-white rounded-lg flex flex-col min-h-[150px] sm:min-h-[500px]">
            {/* Pokemon Image Section */}
            <div className="flex-[2] flex flex-col items-center justify-center p-2 sm:p-4">
              <div 
                className="relative w-28 h-28 sm:w-40 sm:h-40 md:w-56 md:h-56 flex items-center justify-center mb-4"
                  ...
                  <div className="bg-gray-100 rounded-lg p-3">
                    <p className="text-sm text-gray-800 font-medium flex items-center gap-2">
                      ...
                      <span
                        ...
                        className="px-2 py-1 bg-blue-600 text-white font-bold rounded-full text-sm inline-flex items-center gap-1"
                      >
          ...
          <div className="w-full md:w-1/2 bg-gray-800 rounded-lg p-4 text-white flex flex-col gap-4">
            ...
            <div className="bg-white rounded-md p-3 flex-1">
              {/* Stats Section */}
              <h3 className="text-lg font-bold sm:text-md text-gray-800 mb-2">
                Stats
                <hr className='border-1 border-gray-200 w-full' />
              </h3>
              <div className="grid grid-cols-2 gap-2 h-auto mb-4">
                {/* First Row */}
                <div className="text-start flex flex-col justify-center min-h-[40px]">
                  <div className="text-sm font-bold text-gray-800 mb-1">Height</div>
                  <div className="text-sm text-gray-800">{pokemon.height.minimum}-{pokemon.height.maximum}</div>
                </div>

                <div className="text-start flex flex-col justify-center min-h-[40px]">
                  <div className="text-sm font-bold text-gray-800 mb-1">Weight</div>
                  <div className="text-sm text-gray-800">{pokemon.weight.minimum}-{pokemon.weight.maximum}</div>
                </div>

                {/* Second Row */}
                <div className="text-start flex flex-col justify-center min-h-[40px]">
                  <div className="text-sm font-bold text-gray-800 mb-1">Max HP</div>
                  <div className="text-sm text-gray-800">{pokemon.maxHP}</div>
                </div>

                <div className="text-start flex flex-col justify-center min-h-[40px]">
                  <div className="text-sm font-bold text-gray-800 mb-1">Max CP</div>
                  <div className="text-sm text-gray-800">{pokemon.maxCP}</div>
                </div>
              </div>
              ...
              {pokemon.attacks && (
                <div>
                  <h3 className="flex text-lg font-bold sm:text-md items-center text-gray-800 mb-2">
                  ...
                  <div className="flex flex-col gap-3">
                    ...
                    <div>
                      <div className="flex items-center mb-1">
                        <span className="px-2 py-1 bg-red-400 text-white font-bold rounded text-xs">
                          Fast Attacks
                        </span>
                      </div>
                        ...
                        {pokemon.attacks.fast.slice(0, 2).map((attack: Attack) => (
                          attack.name && (
                            ...
                            <div className="flex items-center gap-2">
                              ...
                              <span className="bg-rose-500 text-white min-w-[35px] font-bold text-center py-0.5 rounded text-xs">
                                {attack.damage}
                              </span>
                            </div>
                          </div>
                    ...
                    <div>
                      <div className="flex items-center mb-1">
                        <span className="px-2 py-1 bg-yellow-400 text-blue-800 rounded text-xs font-bold">
                          Special Attacks
                        </span>
                      </div>
                      <div className="space-y-1">
                        {pokemon.attacks.special.slice(0, 2).map((attack: Attack) => (
                          attack.name && (
                            ...
                            <div className="flex items-center gap-2">
                              <span className="text-gray-600">{attack.type}</span>
                              <span className="bg-yellow-400 text-blue-800 min-w-[35px] font-bold text-center py-0.5 rounded text-xs">
                                {attack.damage}
                              </span>
                            </div>
                          </div>
            ...
            {pokemon.resistant && pokemon.resistant.length > 0 && (
              <div className="border-1 border-white bg-white rounded-md p-3 md:p-3 md:pl-2 h-auto">
                <h3 className="flex items-center justify-start text-lg md:text-xl font-bold text-gray-800 p-1 mb-3">
                  ...
                  <span className="text-emerald-600">Resistances</span>
                </h3>
                <div className="flex flex-wrap gap-2 h-auto">
                  {pokemon.resistant.map((type: string) => (
                    <span key={type} className="px-3 py-1 bg-emerald-500 text-white rounded-md text-sm font-medium">
                      {type}
                    </span>
                  ))}
                </div>
